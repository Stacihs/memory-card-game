 ...
 *    + if all cards have matched, display a message with the final score (put this    const card = document.querySelector(".card");
 other function that you call from this one)
 */
 ...
 //add open card to list of open cards
 //check for card matches
 //remove non-matching cards from list and hide symbol
